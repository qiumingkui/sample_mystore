...
public class StoredEvent {
	...
	protected void setEventBody(String anEventBody) {
		Assert.assertArgumentNotEmpty(anEventBody, "The event body is required.");
		Assert.assertArgumentLength(anEventBody, 1, 65000, "The event body must be 65000 characters or less.");
	...
	protected void setTypeName(String aTypeName) {
		Assert.assertArgumentNotEmpty(aTypeName, "The event type name is required.");
		Assert.assertArgumentLength(aTypeName, 1, 100, "The event type name must be 100 characters or less.");
