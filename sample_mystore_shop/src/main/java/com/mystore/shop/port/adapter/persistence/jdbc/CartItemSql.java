...
//import com.mystore.shop.domain.model.customer.ProductItemId;
//
//@Component
//public class CartItemSql extends JdbcCurdDao<CartBase, CartId> {
//
//	public List<CartBase> findAllByProductItemId(ProductItemId customerId) {
//		List<CartId> cartIds = findAllIdByNameLike(customerId);
//		List<CartBase> cartBases = findAll(cartIds);
//		return cartBases;
//	}
//
//	public List<CartId> findAllIdByNameLike(ProductItemId customerId) {
